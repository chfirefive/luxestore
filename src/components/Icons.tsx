...
// Centralized SVG icon library for LuxeStore
export const Icons = {
  // Nav & Branding
  ...
  // Buyer / Owner Selection Panel
  Buyer: (props: SVGProps<SVGSVGElement> = {}) => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <circle cx="9" cy="21" r="1"/><circle cx="20" cy="21" r="1"/>
      <path d="M1 1h4l2.68 13.39a2 2 0 0 0 2 1.61h9.72a2 2 0 0 0 2-1.61L23 6H6"/>
    </svg>
  ),
  Owner: (props: SVGProps<SVGSVGElement> = {}) => (
    <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.25" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
  ...
  ArrowRight: (props: SVGProps<SVGSVGElement> = {}) => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" {...props}>
  ...
  Fire: (props: SVGProps<SVGSVGElement> = {}) => (
    <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="none" {...props}>
      <path d="M12.9 2.1c.4 1.9.1 3.7-.8 5.2C10.6 4.8 8.9 3.4 6.4 3.9c.5 2.1 1.9 3.9 3.6 5.1C7.7 9.4 5.6 9 4 7.6c-.2 1.3.1 2.7.9 3.9-1-.4-2-.9-2.8-1.7.2 3.4 2.4 6.4 5.6 7.6C5.3 18.7 3 19 1 18.4c2.1 2.4 5.4 3.8 9 3.6 6.4-.4 11-5.6 11-12 0-4.2-2-7.9-5.2-10.2-1.5 1-2.2 2.8-2.9 4.3z"/>
    </svg>
  ),
  ...
  Check: (props: SVGProps<SVGSVGElement> = {}) => (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="2.25" strokeLinecap="round" strokeLinejoin="round" {...props}>
  ...
  Trash: (props: SVGProps<SVGSVGElement> = {}) => (
    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" {...props}>
